...
var Widget = function(_args) {
	...
	self.add(Ti.UI.createTextField({
		...
		borderStyle : isAndroid ? undefined : Ti.UI.INPUT_BORDERSTYLE_ROUNDED,
		top : 23,
	...
	var _animation = {
		ANIMATION_UP : function() {
			...
			self.children[0].animate({
				...
				"left" : isAndroid ? (-lenHint + 2) : -lenHint, //Fix hint being cut off on Android
	...
	self.setValue = function(value, up) {
		...
		self.children[1].fireEvent(_events.CHANGE, {});
